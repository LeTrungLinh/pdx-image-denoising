...
from model_cbam import RDUNet, init_weights
from data_management import NoisyImagesDataset, DataSampler
from train import fit_model
from transforms_test import AdditiveWhiteGaussianNoise, RandomHorizontalFlip, RandomVerticalFlip, RandomRot90
...
def main():
    ...
    criterion = nn.L1Loss()
    optimizer = optim.AdamW(param_group, lr=learning_rate, weight_decay=0.0005)
